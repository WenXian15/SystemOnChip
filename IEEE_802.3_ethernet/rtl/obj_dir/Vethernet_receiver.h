...
#ifndef VERILATED_VETHERNET_RECEIVER_H_
#define VERILATED_VETHERNET_RECEIVER_H_  // guard

#include "verilated.h"

class Vethernet_receiver__Syms;
class Vethernet_receiver___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class Vethernet_receiver VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vethernet_receiver___024root* const rootp;
    ...
    explicit Vethernet_receiver(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vethernet_receiver(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vethernet_receiver();
  private:
    VL_UNCOPYABLE(Vethernet_receiver);  ///< Copying not allowed
